package com.apptarixtv.twitter;
...
public class TwitterLogin extends Activity {
	...
	private final TwDialogListener mTwLoginDialogListener = new TwDialogListener() {
		...
		public void onComplete(String value) {
			...
			Toast.makeText(TwitterLogin.this, "Connected to Twitter as " + username, Toast.LENGTH_LONG).show();
		}
		...
		public void onError(String value) {
			...
			Toast.makeText(TwitterLogin.this, "Twitter connection failed", Toast.LENGTH_LONG).show();
		}
	};
}